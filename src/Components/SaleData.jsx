const saleData = [
  {
    ...
    reviews: 132,
    description:
      "Ergonomic USB gamepad with dual vibration and turbo function, ideal for PC gaming.",
    image:
  ...
  },
  {
    ...
    reviews: 89,
    description:
      "Mechanical wired keyboard with RGB backlight, designed for gamers and typists.",
    image:
  ...
  },
  {
    ...
    reviews: 205,
    description:
      "24-inch IPS LCD monitor with ultra-fast refresh rate and minimal response time.",
  ...
  },
  {
    ...
    reviews: 97,
    description:
      "High-performance gaming laptop with Ryzen 7 CPU and RTX 4050 GPU.",
    image:
  ...
  },
  {
    ...
    reviews: 58,
    description:
      "Advanced RGB liquid CPU cooler for high-performance PC builds.",
    image:
